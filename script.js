const osintData = [
  ...
  { category: "Images / Videos / Docs", tools: [
    ...
    { name: "Google Lens", url: "https://lens.google.com/", tags: ["open"], desc: "Visual search interface for reverse image lookup, object recognition, and source discovery using cropped regions." },
    ...
    { name: "Berify", url: "https://berify.com/", tags: ["login", "paid"], desc: "Reverse image matching platform that monitors reused photos and can alert when matches appear online." },
    { name: "IQDB", url: "https://iqdb.org/", tags: ["open"], desc: "Reverse image matcher optimized for finding visually similar variants and reposts, especially heavily edited images." },
    { name: "Karma Decay", url: "https://karmadecay.com/", tags: ["open"], desc: "Reddit-focused reverse image search tool for locating prior submissions of the same or similar images." },
    { name: "Social Catfish Reverse Image Search", url: "https://socialcatfish.com/reverse-image-search/", tags: ["paid"], desc: "Identity-focused reverse image workflow for tracing reused profile photos across public web sources." },
    ...
    { name: "Search4Faces", url: "https://search4faces.com/", tags: ["open"], desc: "Face search service aimed at finding matching social profile photos across indexed public datasets." },
...
const CATEGORY_ICON_MAP = {
  ...
  'business records': 'building-2',
  'cloud infrastructure': 'cloud',
  'compliance & risk intelligence': 'shield-check',
  'cyber threat intelligence': 'shield-alert',
  'dark web': 'eye-off',
  'dating': 'heart',
  'disinformation & media verification': 'badge-check',
  'documentation / evidence capture': 'file-search',
  'domain name': 'globe-2',
  'email address': 'mail-search',
  'encoding / decoding': 'braces',
  'geolocation tools / maps': 'map-pin',
  'ip & mac address': 'server',
  'images / videos / docs': 'image',
  'instant messaging': 'message-square',
  ...
  'username': 'at-sign',
  'vehicle records': 'car',
  'financial data': 'trending-up',
  'leaked data': 'database-zap',
